...
void Camera::followHelicopter(std::shared_ptr<MatrixStack> MV, glm::mat4 E, float offset) const{
    MV->rotate(float(-90.0f / 180.0f * M_PI), glm::normalize(glm::vec3(0, 1, 0)));
    MV->translate(-std::abs(offset), 0, 0);
